                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                <?php echo e(auth('admins')->first_name); ?>
                        ...
                        <li class="user-footer">
                            <div class="">
                                <form id="logout" action="<?php echo e(url('admin-panel/logout')); ?>" method="post">
...
</header><?php /**PATH E:\xampp\htdocs\shortly\views/admin/layouts/header.blade.php ENDPATH**/ ?>