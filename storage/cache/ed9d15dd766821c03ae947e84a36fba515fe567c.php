                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="<?php echo e(url('login')); ?>" method="post">
                            <div  class="form-group">
                                ...
                                <input type="text" name="user_name" id="user_name" class="form-control <?php if($errors && $errors->has('user_name')): ?> is-invalid <?php endif; ?>" placeholder="Username" required autofocus value="<?php echo e($old?$old['user_name']:''); ?>">
...
<?php echo $__env->make('web.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\shortly\views/web/auth/login.blade.php ENDPATH**/ ?>